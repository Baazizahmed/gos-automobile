...
final class PostController extends AbstractController
{
    ...
    public function create(Request $request): Response
    {
        if (0 == count($this->categoryRepository->findAll())) {
            $this->addFlash('warning', 'Pour créer un nouvel service, vous devez créer au moins une catégorie.');
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success', 'Le servie a été créé et sauvegardé.');
    ...
    public function edit(Post $post, Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success', 'Le service a été modifié et sauvegardé.');
    ...
    public function publish(Post $post, Request $request): Response
    {
        ...
        if ($post->isPublished()) {
            ...
            $this->addFlash('success', 'Cet service a été publié.');
        }

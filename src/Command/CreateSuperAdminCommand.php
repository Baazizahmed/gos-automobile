...
class CreateSuperAdminCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        // ==========================================================
        // ETAPE 1 : Valider le mot de passe en clair SÉPARÉMENT
        // ==========================================================
        $passwordConstraints = [
            ...
            new Regex([
                ...
                'message' => 'Le mot de passe doit contenir au moins une lettre minuscule, majuscule, un chiffre et un caractère spécial.',
            ]),
        ];

        $passwordErrors = $this->validator->validate($plainPassword, $passwordConstraints);

        if (count($passwordErrors) > 0) {
            $this->io->error("Le mot de passe fourni n'est pas valide :");
        ...
        // ==========================================================
        // ETAPE 2 : Créer l'utilisateur avec le mot de passe HASHÉ
        // ==========================================================

        $superAdmin = new User();

        $superAdmin->setFirstName('Guillaume');
        $superAdmin->setLastName('GOSNET');
